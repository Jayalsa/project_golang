...
type ProductServiceClient interface {
	...
	GetProducts(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*GetProductResponse, error)
}
...
func (c *productServiceClient) GetProducts(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*GetProductResponse, error) {
	out := new(GetProductResponse)
...
type ProductServiceServer interface {
	...
	GetProducts(context.Context, *EmptyRequest) (*GetProductResponse, error)
...
func (UnimplementedProductServiceServer) GetProducts(context.Context, *EmptyRequest) (*GetProductResponse, error) {
...
func _ProductService_GetProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProducts(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
